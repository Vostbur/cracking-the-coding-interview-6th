...
class TestLinkedList(unittest.TestCase):
    ...
    def test_05_insert_after_item_exception(self):
        self.assertRaises(LinkedListException,
                          self.linked_list.insert_after_item, 5, 0)
    ...
    def test_07_insert_before_item_exception(self):
        self.assertRaises(LinkedListException,
                          self.linked_list.insert_before_item, 6, 0)
    ...
    def test_09_insert_at_index_exception(self):
        self.assertRaises(LinkedListException,
                          self.linked_list.insert_at_index, 10, 0)
    ...
    def test_19_delete_element_by_value_exception(self):
        self.assertRaises(LinkedListException,
                          self.linked_list.delete_element_by_value, 10)
