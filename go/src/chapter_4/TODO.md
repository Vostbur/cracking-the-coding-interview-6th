...
Попробуйте изменить алгоритм поиска в графе, чтобы он отслеживал глубину от корня

Также может пригодиться хеш-таблица или массив, связывающий номер
уровня с количеством узлов на этом уровне

Попробуйте разработать алгоритм, сочетающий поиск в глубину с поиском
в ширину
